...
declare type onDoneCallback = (url: string, body: Body, response: Response) => void | Promise<void>;
declare type WebhooksProps = {
    /**
     * Version of the API
     */
    api_version: string;
 ...
 * @returns
 */
declare function createSecret(length?: number): string;
/**
 ...
 * @returns boolean
 */
declare function verifySignature(secret: string, signature: string, body: string): boolean;
/**
 * Webhooks class
 * @class
 ...
 * });
 */
declare class WebhookClient<Type extends EventType> {
    readonly hooks: Hook[];
    private secret;
    private name?;
    private mode;
...
export { Body, Environment, EventType, Hook, WebhookClient, WebhooksProps, createSecret, onDoneCallback, verifySignature };
